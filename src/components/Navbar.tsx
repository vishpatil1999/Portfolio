        ...
        <>
            ...
            >
                <a href="https://prebuiltui.com?utm_source=eliana">
                    <img src="./assets/vishakha.png" alt="Logo" className="w-28 cursor-pointer mr-14 dark:hidden" />
                ...
                >
                    ...
                    {/* <li><a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#services">Achievements</a></li> */}
                ...
                >
                    ...
                    {/* <li><a href="#services" onClick={closeMenu}>Achievements</a></li> */}
